...
public class DriverUtility extends Base {
	...
	public static void scrollPageDownWihtJS(WebDriver driver) {
	...
	// sendKeys using Java Script Executer
	...
	public static void dragAndDrop(WebElement sourceElemet, WebElement targetElement) {
		Actions action = new Actions(driver);
		action.dragAndDrop(sourceElemet, targetElement);
	}
